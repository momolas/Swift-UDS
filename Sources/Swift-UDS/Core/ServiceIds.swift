...
extension UDS {
    ...
    public enum ServiceId {
        ...
        public static let kwpStartDiagnosticSession                   : UInt8 = 0x10
        ...
        public static let kwpTesterPresent                            : UInt8 = 0x3E

        public static let kwpStartCommunication                       : UInt8 = 0x81
        public static let kwpStopCommunication                        : UInt8 = 0x82
        public static let kwpAccessTimingParameters                   : UInt8 = 0x83
    ...
    public struct OBD2Response: ConstructableViaMessage, CustomStringConvertible {
        ...
        public init(message: UDS.Message) {
            ...
            var sid = message.bytes[0] & ~0x40
            let pid = message.bytes[1]
            if sid == UDS.ServiceId.powertrainFreezeFrameData {
                // The specs are written with the current frame in mind
                sid = UDS.ServiceId.currentPowertrainDiagnosticsData
            }
            guard let spec = UDS.OBD2.messageSpecs.first(where: { $0.sid == sid && $0.pid == pid }) else {
                logger.debug("Can't find a matching spec for response \(sid, radix: .hex, prefix: true, toWidth: 2) \(pid, radix: .hex, prefix: true, toWidth: 2)")
                self.value = nil
    ...
    public enum DiagnosticSessionType: UInt8 {
        ...
        // KWP / GMLAN
        case kwpDefault                         = 0x81
        case kwpUpload                          = 0x82
        case kwpDownload                        = 0x83
        case kwpProgramming                     = 0x84
        case kwpDevelopment                     = 0x85
        case kwpAdjustment                      = 0x86
        case kwpVehicleUpload                   = 0x87
        case kwpVehicleDownload                 = 0x89
        case kwpVehicleCustomerServiceUpload    = 0x90
        case kwpVehicleCustomerServiceDownload  = 0x91
        case kwpEndCustomerServiceUpload        = 0x92
        case kwpEndCustomerServiceDownload      = 0x93
    }
    ...
    /// Service 0x18 – Read DTC By Status (KWP)
    public enum KWPReadDTCByStatusType: UInt8 {

        case requestStoredDTCAndStatus                          = 0x02
        case requestAllDTCAndStatus                             = 0x03
        case requestPendingDTCAndStatus                         = 0x11
        case requestStatusBitsSupported                         = 0xFF
    }

    /// DTC Response: Responses containing one or more two-byte-diagnostic trouble codes
    public struct KWPDTCResponse: ConstructableViaMessage, CustomStringConvertible {
        ...
        public init(message: UDS.Message) {
            ...
            let dtcStartOffset = 2
            self.dtc = message.bytes[dtcStartOffset...].CC_chunked(size: 3).map { UDS.DTC(from: $0) }
        }
    ...
    /// Service 0x1A – Read ECU Identification (KWP)
    public struct DataIdentifier8Response: ConstructableViaMessage {
        ...
        public init(message: UDS.Message) {
            ...
            let id = message.bytes[1]
            let payload = message.bytes[2...]
            self.dataIdentifier = id
            self.dataRecord = Array(payload)
        }

        public let dataIdentifier: DataIdentifier8
...
/// Predefined values as per ISO14203-3 and GMW3110-2010 – all other values are vendor-specific.
public extension UDS.KWPECUIdentificationOption {

    static let dataTable                                                        : UInt8 = 0x80
    static let scaling                                                          : UInt8 = 0x81
    static let vehicleManufacturerSparePartNumber                               : UInt8 = 0x87
    static let vehicleManufacturerEcuSoftwareNumber                             : UInt8 = 0x88
    static let vehicleManufacturerEcuSoftwareVersionNumber                      : UInt8 = 0x89
    static let ecuManufacturingDate                                             : UInt8 = 0x8B
    static let ecuSerialNumber                                                  : UInt8 = 0x8C
    ...
    static let configurationOrCustomizationData1                                : UInt8 = 0xA1
    static let configurationOrCustomizationData2                                : UInt8 = 0xA2
    static let configurationOrCustomizationData3                                : UInt8 = 0xA3
    static let configurationOrCustomizationData4                                : UInt8 = 0xA4
    static let configurationOrCustomizationData5                                : UInt8 = 0xA5
    static let configurationOrCustomizationData6                                : UInt8 = 0xA6
    static let configurationOrCustomizationData7                                : UInt8 = 0xA7
    static let configurationOrCustomizationData8                                : UInt8 = 0xA8

    static let diagnosticAddress                                                : UInt8 = 0xB0
    static let functionalSystemsAndVirtualDevices                               : UInt8 = 0xB1
    ...
    static let odometerValue                                                    : UInt8 = 0xDF
